...
$first_name = $last_name = $username = $password = $phone_number = $email = '';
$first_nameErr = $last_nameErr = $usernameErr = $passwordErr = $phone_numberErr = $emailErr = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($first_nameErr) && empty($last_nameErr) && empty($emailErr) && empty($phone_numberErr) && empty($usernameErr) && empty($passwordErr)) {
